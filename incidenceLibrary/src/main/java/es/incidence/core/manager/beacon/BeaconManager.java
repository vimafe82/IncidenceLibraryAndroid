...
import es.incidence.core.manager.auto.AutoReceiver;
...
public class BeaconManager implements RangeNotifier, MonitorNotifier
{
    ...
    private static void initBeaconManager(Context context)
    {
        BeaconManager.instance.beaconManager = org.altbeacon.beacon.BeaconManager.getInstanceForApplication(context);
        BeaconManager.instance.beaconManager.addMonitorNotifier(BeaconManager.instance);
        BeaconManager.instance.beaconManager.addRangeNotifier(BeaconManager.instance);
        BeaconManager.instance.beaconManager.setDebug(false);

        BeaconManager.instance.beaconManager.getBeaconParsers().clear();
        BeaconManager.instance.beaconManager.getBeaconParsers().add(new BeaconParser().setBeaconLayout(BEACON_LAYOUT));

        BeaconManager.instance.beaconManager.setForegroundBetweenScanPeriod(0);
        BeaconManager.instance.beaconManager.setForegroundScanPeriod(1100);
        BeaconManager.instance.beaconManager.setEnableScheduledScanJobs(false);
        BeaconManager.instance.beaconManager.setBackgroundBetweenScanPeriod(0);
        BeaconManager.instance.beaconManager.setBackgroundScanPeriod(1100);
        BeaconManager.instance.beaconManager.setRegionExitPeriod(5000);

        //INIT Código para detección rápida cuando la app está cerrada
        ...
        pIntent.setAction("beacon_search");
        //PendingIntent pendingIntent = PendingIntent.getActivity(context, 0 /* Request code */, pIntent, PendingIntent.FLAG_UPDATE_CURRENT);

        PendingIntent pendingIntent = null;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            pendingIntent = PendingIntent.getActivity(context, 0 /* Request code */, pIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);

        }else {
            pendingIntent = PendingIntent.getActivity(context, 0 /* Request code */, pIntent,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            ...
            NotificationChannel mChannel = notificationManager.getNotificationChannel(CHANNEL_ID_BEACON_SCAN);
            ...
            if (mChannel == null)
            {
                ...
                NotificationChannel channel = new NotificationChannel(CHANNEL_ID_BEACON_SCAN, name, importance);
            ...
            /*
            NotificationChannel mChannel = new NotificationChannel(BeaconManager.CHANNEL_ID_SHOW, name+"_show", NotificationManager.IMPORTANCE_HIGH);
            mChannel.setDescription(description+"_show");
        ...
        BeaconManager.instance.builder = new NotificationCompat.Builder(context)
                .setContentTitle(context.getString(R.string.beacon_notif_title))
                .setContentText(context.getString(R.string.beacon_notif_subtitle))
                // AA
                .setSmallIcon(R.drawable.ic_notif_beacon)
                .setChannelId(CHANNEL_ID_BEACON_SCAN)
                .setContentIntent(pendingIntent)
                //.setAutoCancel(false)
                .setVibrate(new long[]{ 0 })
                .setPriority(NotificationCompat.PRIORITY_MIN) // PRIORITY_DEFAULT
                ;
        ...
        BeaconManager.instance.backgroundPowerSaver = new BackgroundPowerSaver(context);
        */
    }
    ...
    public static void showNotificationBeaconDetected(Context context, String region)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            pendingIntent = PendingIntent.getActivity(context, 0 /* Request code */, pIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        }
        ...
        //PendingIntent pendingIntent2 = PendingIntent.getActivity(context, 0 /* Request code */, carIntent,
          //      PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        builder.setContentTitle(BeaconManager.instance.STR_BEACON_DETECTED_TITLE)       // required
                ...
                .extend(
                        /*new CarAppExtender.Builder()
                                .setContentTitle(context.getString(R.string.ask_beacon_activated))
                                .setContentText(context.getString(R.string.ask_beacon_activated_desc))
                                .setSmallIcon(R.drawable.ic_notif_beacon)
    ...
    public void didExitRegion(Region arg0)
    {
        ...
        showNotificationBeaconSearch(getApplicationContext());
