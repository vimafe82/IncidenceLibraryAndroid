...
import com.e510.firebase.Firebase;
...
public class Core {
    ...
    public static void updateLiterals(boolean forceUpdate) {
        ...
        if (valores != null) {
            ...
            if (list != null) {
                ...
                if (forceUpdate)
                {
                    IApplication.INSTANCE.restartApp();
                }
            }
        }
    }
    ...
    public static String getLiteralVoice(String stringId, Context context) {
        ...
        if (res == null) {
            int text_id = IApplication.INSTANCE.getResources().getIdentifier(stringId, "string", context.getPackageName());
            res = IApplication.INSTANCE.getResources().getString(text_id);
        }
    ...
    public static String getString(int stringId)
    {
        ...
        BaseActivity baseActivity = IApplication.INSTANCE.getCurrentActivity();
        ...
        {
            String strId = IApplication.INSTANCE.getResources().getResourceEntryName(stringId);
    ...
    public static Locale getLocaleLanguage() {
        ...
        return IApplication.INSTANCE.getResources().getConfiguration().locale;
    }
