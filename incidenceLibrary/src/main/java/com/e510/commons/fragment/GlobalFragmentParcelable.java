...
public abstract class GlobalFragmentParcelable extends Fragment implements Parcelable {

    public GlobalFragmentParcelable() {
        // TODO Auto-generated constructor stub
    }

    public GlobalFragmentParcelable(Parcel in) {
    ...
    public static final Parcelable.Creator<GlobalFragmentParcelable> CREATOR = new Parcelable.Creator<GlobalFragmentParcelable>() {
        public GlobalFragmentParcelable createFromParcel(Parcel in) {
            ...
            try {
                ...
                GlobalFragmentParcelable model = (GlobalFragmentParcelable) parceledClass.newInstance();
                rehydrate(model, in);
                return model;
        ...
        public GlobalFragmentParcelable[] newArray(int size) {
            return new GlobalFragmentParcelable[size];
        }
    };
    ...
    // writes fields of a GlobalFragmentParcelable to a parcel
    // does not include the first parcelled item -- the class name
    protected static void dehydrate(GlobalFragmentParcelable model, Parcel out) throws IllegalArgumentException, IllegalAccessException {
        ...
        for (Field field : fields){
            ...
            } else if (GlobalFragmentParcelable.class.isAssignableFrom(field.getType())) {
                // why did this happen?
                //Log.e("GlobalParcelable", "GlobalFragmentParcelable F*ck up: " + " (" + field.getType().toString() + ")");
                out.writeParcelable((GlobalFragmentParcelable) field.get(model), 0);
            } else {
                // wtf
    ...
    protected static void rehydrate(GlobalFragmentParcelable model, Parcel in) throws IllegalArgumentException, IllegalAccessException {
        ...
        for (Field field : fields){
            ...
            if (field.getType().equals(int.class)) {
                ...
                //Log.e("GlobalParcelable", "read GlobalFragmentParcelable: " + " (" + field.getType().toString() + ")");
