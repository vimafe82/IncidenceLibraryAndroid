...
public class CircleImageView extends AppCompatImageView {
    ...
    public void setEnabled(boolean enabled) {
        ...
        int colorPrimary = mCircleBackgroundColor;
        int colorWhite = getResources().getColor(R.color.white);
        int colorBorder = enabled ? mBorderColor : ColorUtils.blendARGB(colorPrimary, colorWhite, 0.5f);
        int color = enabled ? colorPrimary : ColorUtils.blendARGB(colorPrimary, colorWhite, 0.5f);
        mCircleBackgroundPaint.setColor(color);
        invalidate();
        mBorderPaint.setColor(colorBorder);
        invalidate();
    }
}