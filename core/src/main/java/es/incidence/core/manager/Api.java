...
public class Api
{
    ...
    public static void getBeaconDetail(final IRequestListener viewListener, String beaconImei)
    {
        String url = Constants.BASE_URL + "/partners/iot_check/" + beaconImei;
        log("Request: " + url);

        HashMap<String, String> params = new HashMap<>();
        params.put("imei", beaconImei);
