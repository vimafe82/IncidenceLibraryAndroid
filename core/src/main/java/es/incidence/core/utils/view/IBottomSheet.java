...
public class IBottomSheet extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (customView != null) {
            ...
            IBottomSheetAdapter adapter = new IBottomSheetAdapter();
                ...
                if (currentSheetAnimation != null && currentSheetAnimation.equals(animation)) {
                    ...
                    if (viewId != -1) {
                        if (onClickListener != null) {
                            onClickListener.onClick(IBottomSheet.this, viewId);
                        }
                    }
    ...
    private IBottomSheet(Context context, boolean needFocus) {
...
//--------------------------------------------------------------------------------------------------
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context) {
            ...
            bottomSheet = new IBottomSheet(context, false);
        }

        public Builder(@NonNull Context context, boolean focus) {
            this.context = context;
            bottomSheet = new IBottomSheet(context, focus);
        }

        public Builder(@NonNull Context context, @BoolRes int focus) {
            this.context = context;
            bottomSheet = new IBottomSheet(context, context.getResources().getBoolean(focus));
        }

        public IBottomSheet.Builder setTitle(@StringRes int titleId) {
            bottomSheet.titleText = context.getText(titleId);
            return this;
        }

        public IBottomSheet.Builder setTitle(@Nullable CharSequence title) {
        ...
        @New(version = "1.1.9")
        public IBottomSheet.Builder setItems(@ArrayRes int itemsId, final OnClickListener listener) {
            bottomSheet.ITEMS.addAll(Arrays.asList(context.getResources().getTextArray(itemsId)));
            bottomSheet.onClickListener = listener;
            return this;
        }

        public IBottomSheet.Builder setItems(@StringRes int[] items, final OnClickListener listener) {
            for (int i : items) {
        ...
        public IBottomSheet.Builder setItems(CharSequence[] items, final OnClickListener listener) {
        ...
        @New(version = "1.1.9")
        public IBottomSheet.Builder setItems(@ArrayRes int itemsId, int[] icons, final OnClickListener listener) {
            bottomSheet.ITEMS.addAll(Arrays.asList(context.getResources().getTextArray(itemsId)));
            for (int i: icons) {
        ...
        @New(version = "1.1.9")
        public IBottomSheet.Builder setItems(@ArrayRes int itemsId, Drawable[] icons, final OnClickListener listener) {
        ...
        public IBottomSheet.Builder setItems(@StringRes int[] items, int[] icons, final OnClickListener listener) {
            for (int i : items) {
                bottomSheet.ITEMS.add(context.getResources().getString(i));
            }
            for (int j: icons) {
        ...
        @New(version = "1.1.9")
        public IBottomSheet.Builder setItems(@StringRes int[] items, Drawable[] icons, final OnClickListener listener) {
            for (int i : items) {
                bottomSheet.ITEMS.add(context.getResources().getString(i));
            }
            Collections.addAll(bottomSheet.ICONS, icons);
        ...
        public IBottomSheet.Builder setItems(@NonNull CharSequence[] items, int[] icons, final OnClickListener listener) {
            bottomSheet.ITEMS.addAll(Arrays.asList(items));
            for (int i: icons) {
                bottomSheet.ICONS.add(ContextCompat.getDrawable(context, i));
            }
        ...
        @New(version = "1.1.9")
        public IBottomSheet.Builder setItems(@NonNull CharSequence[] items, Drawable[] icons, final OnClickListener listener) {
            bottomSheet.ITEMS.addAll(Arrays.asList(items));
            Collections.addAll(bottomSheet.ICONS, icons);
            bottomSheet.onClickListener = listener;
            return this;
        ...
        public IBottomSheet.Builder setMenu(@MenuRes int menuResId, final OnClickListener listener) {
        ...
        public IBottomSheet.Builder setMenu(Menu menu, final OnClickListener listener) {
            for (int i = 0; i < menu.size(); i++) {
                bottomSheet.ITEMS.add(menu.getItem(i).getTitle());
                bottomSheet.ICONS.add(menu.getItem(i).getIcon());
            }
        ...
        public IBottomSheet.Builder setView(@LayoutRes int layoutResId) {
            bottomSheet.customView = LayoutInflater.from(context).inflate(layoutResId, null);
            return this;
        }

        public IBottomSheet.Builder setView(View view) {
...
//----- Styles -------------------------------------------------------------------------------------
        ...
        public IBottomSheet.Builder setContentType(@IBottomSheet.Type int type) {
            bottomSheet.contentType = type;
            return this;
        }

        public IBottomSheet.Builder setDarkTheme(boolean theme) {
            bottomSheet.darkTheme = theme;
            return this;
        }

        public IBottomSheet.Builder setDarkTheme(@BoolRes int theme) {
        ...
        public IBottomSheet.Builder setFullWidth(boolean fullWidth) {
            bottomSheet.fullWidth = fullWidth;
            return this;
        }

        public IBottomSheet.Builder setFullWidth(@BoolRes int fullWidth) {
            bottomSheet.fullWidth = context.getResources().getBoolean(fullWidth);
            return this;
        }

        public IBottomSheet.Builder setCellHeight(int cellHeight) {
        ...
        public IBottomSheet.Builder setDividers(boolean dividers) {
            bottomSheet.dividers = dividers;
            return this;
        }

        public IBottomSheet.Builder setDividers(@BoolRes int dividers) {
        ...
        public IBottomSheet.Builder setWindowDimming(@IntRange(from = 0, to = 255) int windowDimming) {
            bottomSheet.dimmingValue = windowDimming;
            return this;
        }

        public IBottomSheet.Builder setTitleMultiline(boolean titleMultiline) {
            bottomSheet.titleTextMultiline = titleMultiline;
            return this;
        }

        public IBottomSheet.Builder setTitleMultiline(@BoolRes int titleMultiline) {
        ...
        @Beta
        @New(version = "0.2.1")
        public IBottomSheet.Builder setFabBehavior(FloatingActionButton fab) {
        ...
        @Beta
        @New(version = "0.2.1")
        public IBottomSheet.Builder setFabBehavior(FloatingActionButton fab, @IBottomSheet.FabBehavior int fabBehavior) {
            bottomSheet.floatingActionButton = fab;
...
//----- Colors -------------------------------------------------------------------------------------
        ...
        public IBottomSheet.Builder setBackgroundColor(@ColorInt int backgroundColor) {
            bottomSheet.backgroundColor = backgroundColor;
            return this;
        }

        @New(version = "1.1.9")
        public IBottomSheet.Builder setBackgroundColorRes(@ColorRes int backgroundColorRes) {
            bottomSheet.backgroundColor = ContextCompat.getColor(context, backgroundColorRes);
            return this;
        }

        public IBottomSheet.Builder setTitleTextColor(@ColorInt int titleTextColor) {
            bottomSheet.titleTextColor = titleTextColor;
            return this;
        }

        @New(version = "1.1.9")
        public IBottomSheet.Builder setTitleTextColorRes(@ColorRes int titleTextColorRes) {
            bottomSheet.titleTextColor = ContextCompat.getColor(context, titleTextColorRes);
            return this;
        }

        public IBottomSheet.Builder setItemTextColor(@ColorInt int itemTextColor) {
            bottomSheet.itemTextColor = itemTextColor;
            return this;
        }

        @New(version = "1.1.9")
        public IBottomSheet.Builder setItemTextColorRes(@ColorRes int itemTextColorRes) {
            bottomSheet.itemTextColor = ContextCompat.getColor(context, itemTextColorRes);
            return this;
        }

        public IBottomSheet.Builder setIconColor(@ColorInt int iconColor) {
            bottomSheet.iconColor = iconColor;
            return this;
        }

        @New(version = "1.1.9")
        public IBottomSheet.Builder setIconColorRes(@ColorInt int iconColorRes) {
            bottomSheet.iconColor = ContextCompat.getColor(context, iconColorRes);
            return this;
        }

        public IBottomSheet.Builder setItemSelector(int selector) {
...
//----- Interfaces ---------------------------------------------------------------------------------
        ...
        @New(version = "1.1.9")
        public IBottomSheet.Builder setOnShowListener(DialogInterface.OnShowListener listener) {
            bottomSheet.onShowListener = listener;
            return this;
        }

        @New(version = "1.1.9")
        public IBottomSheet.Builder setOnDismissListener(DialogInterface.OnDismissListener listener) {
            bottomSheet.onDismissListener = listener;
            return this;
        }

        public IBottomSheet.Builder setCallback(BottomSheetCallback callback) {
...
//----- Deprecated ---------------------------------------------------------------------------------
        ...
        @Deprecated
        public IBottomSheet.Builder setCustomView(View view) {
            bottomSheet.customView = view;
            return this;
        }

        @Deprecated
        public IBottomSheet.Builder setCustomView(@LayoutRes int layoutResId) {
            bottomSheet.customView = LayoutInflater.from(context).inflate(layoutResId, null);
            return this;
        }
    }
...
//--------------------------------------------------------------------------------------------------
    ...
    private class IBottomSheetAdapter extends BaseAdapter {
