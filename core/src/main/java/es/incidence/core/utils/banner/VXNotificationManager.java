package es.incidence.core.utils.banner;
...
import es.incidence.core.manager.beacon.RestartReceiver;
...
public class VXNotificationManager
{
        ...
        try
        {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
            {
                ...
                builder.setContentTitle(title)       // required
                        ...
                        .setAutoCancel(true)
                        .setDeleteIntent(getDeleteIntent(app))
    ...
    protected static PendingIntent getDeleteIntent(Application app)
    {
        Intent intent = new Intent(app, RestartReceiver.class);
        intent.setAction("incidence.BOOT_SERVICE");

        PendingIntent pendingIntent;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            pendingIntent = PendingIntent.getBroadcast(app, 0, intent, PendingIntent.FLAG_CANCEL_CURRENT | PendingIntent.FLAG_IMMUTABLE);

        }else {
            pendingIntent = PendingIntent.getBroadcast(app, 0, intent, PendingIntent.FLAG_CANCEL_CURRENT);
        }
