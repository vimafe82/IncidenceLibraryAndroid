...
public class BaseActivity extends AppCompatActivity implements OnFragmentInteractionListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        BaseApplication.INSTANCE.activityCreated(this);
    ...
    protected void onDestroy() {
        super.onDestroy();
        BaseApplication.INSTANCE.activityDestroyed(this);
        unRegisterEventBus();
    }
    ...
    public void onStart() {
        super.onStart();
        BaseApplication.INSTANCE.activityStarted();
    }

    @Override
    public void onStop() {
        super.onStop();
        BaseApplication.INSTANCE.activityStopped();
    }
    ...
    public void showAlert(String title, String message, DialogInterface.OnClickListener listener)
    {
        ...
        builder.setNegativeButton(com.e510.commons.R.string.ws_response_default_ok_button, listener);
        builder.create().show();
    }
