...
public class BaseFragment extends GlobalFragmentParcelable {
    ...
    {
        showAlert(getString(titleId), getString(messageId), listener, com.e510.commons.R.string.ws_response_default_ok_button);
    }

    public void showAlert(String title, String message, DialogInterface.OnClickListener listener)
    {
        showAlert(title, message, listener, com.e510.commons.R.string.ws_response_default_ok_button);
    }
